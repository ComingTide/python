...
if __name__ == '__main__':
    cache = Cache()
    print(cache.get('https://github.com/ComingTide'))
    print(cache.get('https://github.com/CommingTide'))
    print(cache.get('https://gethub.com/ComingTide'))
    print(cache.get('https://gb.ru'))
    print(cache.get('https://gb.ru'))
    print(cache.get('https://gb.su'))
