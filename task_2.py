...
"""
Декратор вызывается для каждого вызова декорируемой функции
Решение: обернуть вызывающий код в функцию
Можно не ипользовать декоратор, использовать memory_usage
Декорировать функцию wrapper в декораторе. 
"""
